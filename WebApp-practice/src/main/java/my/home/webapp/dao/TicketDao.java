...
import my.home.webapp.entity.Ticket;
...
public class TicketDao implements Dao<Long, Ticket> {
    ...
    private static final String FIMD_ALL_BY_FLIGHT_ID = """
            SELECT id,
            passenger_no,
            passenger_name,
            flight_id,
    ...
    public List<Ticket> findAllByFlightId(Long flightId) {
        try (Connection connection = ConnectionManager.get();
             PreparedStatement prepareStatement = connection.prepareStatement(FIMD_ALL_BY_FLIGHT_ID)) {
